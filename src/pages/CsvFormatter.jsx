      ...
      if (buyerRows.length > 0 && sellerRows.length === 0) {
        ...
        sellerRows.forEach((sr) => {
          ...
          outputRows.push({
            ...
            "Home Address Line 1": sr.parsedAddress.line1,
            "Home Address Line 2": sr.parsedAddress.line2,
            "Home Address City": sr.parsedAddress.city,
            "Home Address State": sr.parsedAddress.state,
            "Home Address Zip Code": sr.parsedAddress.zip,
            Phone: phone,
            Email: email,
            Groups: "Past Clients",
        ...
        buyerRows.forEach((br) => {
          ...
          if (samePropSeller) {
            ...
            outputRows.push({
              ...
              "Home Address Line 1": samePropSeller.parsedAddress.line1,
              "Home Address Line 2": samePropSeller.parsedAddress.line2,
              "Home Address City": samePropSeller.parsedAddress.city,
              "Home Address State": samePropSeller.parsedAddress.state,
              "Home Address Zip Code": samePropSeller.parsedAddress.zip,
              Phone: phone,
              Email: email,
              Groups: "Past Clients",
